...
std::vector<double> Srange::mesh(const int nSteps, const double sImp, const bool equal) const {
...
std::vector<double> Vrange::mesh(const int nSteps, const bool equal) const {
	std::vector<double> meshes(nSteps+1);
...
std::vector<double> Rrange::mesh(const int nSteps, const double rImp, const bool equal) const {
	std::vector<double> meshes(nSteps+1);
