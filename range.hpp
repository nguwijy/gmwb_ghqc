...
class Srange : public Range {
	...
	public:
		...
		//mesher
		std::vector<double> mesh(const int nSteps, const double sImp, const bool equal) const;
};
...
class Vrange : public Range {
	...
	public:
		...
		//mesher
		std::vector<double> mesh(const int nSteps, const bool equal) const;
};
...
class Rrange : public Range {
	...
	public:
		...
		//mesher
		std::vector<double> mesh(const int nSteps, const double rImp, const bool equal) const;
};
